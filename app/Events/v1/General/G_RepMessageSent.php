...
class G_RepMessageSent
{
    ...
    {
        return [
            new PrivateChannel('repair.chat.' . $this->message->rep_chat_id)
        ];
    }
    ...
    {
        return (G_RepChatMessageResource::make($this->message->load(['sender', 'offer'])))->resolve();
    }
